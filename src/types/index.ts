...
export interface Employee{ id:string;name:string;username?:string;email:string;phone:string;role:AccountRole;classification:Classification;preferredPeriod?:ShiftPeriod;position:string;active:boolean }
